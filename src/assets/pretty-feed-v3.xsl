  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      <head>
        ...
        <link rel="stylesheet" href="/assets/css/global/feeds.css"/>
      </head>
      <body class="rss-feed">
        <nav class="nav">
          <div class="nav__notice">
            ...
            <p><code><xsl:value-of select="/rss/channel/docs"/><xsl:value-of select="/atom:feed/atom:id"/>feed.xml</code></p>
          ...
          <xsl:for-each select="/atom:feed/atom:entry">
            <div>
              ...
              <small class="text-gray">
                Originally published: <xsl:value-of select="substring(atom:updated, 0, 11)" />
              </small>
